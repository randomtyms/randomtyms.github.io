...
function boot() {
  ...
  function setFact(id) {
    ...
    if (b.short && factWatch) {
      factWatch.dataset.short = b.short;
      factWatch.href = youtubeWatchUrl(b.short);
      factWatch.textContent = "Watch " + b.name;
      factWatch.hidden = false;
    } else if (factWatch) {
      factWatch.hidden = true;
      delete factWatch.dataset.short;
    }
  ...
  if (song) song.addEventListener("click", pauseSky);
